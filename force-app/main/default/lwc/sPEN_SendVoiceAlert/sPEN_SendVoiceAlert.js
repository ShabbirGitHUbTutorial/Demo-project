...
import getDetailsForPSRs from '@salesforce/apex/SPEN_SendVoiceAlertCallService.alertService';
...
handleClick(event) {
    ...
    console.log('handle click');
        //try{
            this.isDisabled = true;
            getDetailsForPSRs({recId: this.recordIds,vcAlertTemplt: this.template})
            .then(result => {
                if(result){
