...
import { debug, getComputedHeight } from "c/sPEN_UtilsImageCapture";

export default class SPEN_ImageSelector extends LightningElement {
  @api
  allImagesData;
  ...
  @api
  addFileMessage = "Add an image to this record."
  @api 
  actionMessage = "Confirm photos";
  @api
  confirmationLabel = "Remove image?";
  @api  
  confirmationMessage = "After uploading the images you can't edit them.";
  @api
  gs6;
